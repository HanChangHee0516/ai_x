...
def update_now_report(wb, analysis, summary):
    ...
    if 'prev_report' in sheet_names:
        ...
        print('prev_report 시트가 존재 하지 않아 섹제 못 함')
    ...
    #now_sheet.range('A3').api.HorizontalAlignmet = -4152
